          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-8 col-xl-9">
                  ...
                  @foreach ($posts as $post)
                      <div class="col-md-6">
                          <div class="card border hover-shadow-6 mb-6 d-block">
                              <a href="{{ route('blogs.show', $post->id) }}"><img class="card-img-top" src="{{ asset('/storage/'. $post->image) }}" alt="Card image cap"></a>
                              <div class="p-6 text-center">
                                <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="#">{{ $post->category->name }}</a></p>
                                <h5 class="mb-0"><a class="text-dark" href="{{ route('blogs.show', $post->id) }}" >{{ $post->title }}</a></h5>
                              </div>
                          </div>
                      </div>
                  @endforeach
                ...
                {{-- Pagination for normal and storing search key if exists across different pages --}}
              ...
              <div class="col-md-4 col-xl-3">
                <div class="sidebar px-4 py-md-0">
                  ...
                  <form class="input-group" action={{ route('blogs.index') }} method="GET">
                  ...
                  <div class="gap-multiline-items-1">
                      ...
                      @foreach ($tags as $tag)
                          <a class="badge badge-secondary" href="{{ route('blogs.tag', $tag->id) }}">{{ $tag->name }}</a>
                      @endforeach
                  </div>
